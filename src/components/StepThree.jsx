...
const StepThree = ({ prevStep, nextStep, formData, setFormData }) => {
  ...
  useEffect(() => {
    // Initialize date based on localStorage or default to 2 days from today
    ...
    <div className="step">
      ...
      <div className="calendar-container">
        <DatePicker
          ...
          minDate={minDate} // Disable today's date and start from tomorrow
          maxDate={maxDate}
