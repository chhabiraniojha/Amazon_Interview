...
const StepZeroVirtual = ({ nextStep, formDataVirtual, setFormDataVirtual }) => {
  ...
  const handleCheckStatus = async () => {
    ...
    try {
      ...
      if (candidateStatus.data.success == true && candidateStatus.data.candidate.
        telephonicInterviewStatus == false
        ) {
        setFormDataVirtual({
          ...formDataVirtual,
